...
<form action="../action/assign_a_chore_action.php" method="POST" id="choreAssignmentForm">
    ...
    <select name="assignUser" id="assignUser" required>
        <!-- Options for dynamically populated user list -->
        <?php
        // Include the function file to fetch user options
        include '../functions/select_role_fxn.php';

        // Fetch and display user options (assuming standard users have role ID 3)
        $standardUsers = get_standard_users(); // Assuming get_standard_users() function is available
