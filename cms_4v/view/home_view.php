...
<body class="bg-gray-100 p-4">
    ...
    <section id="content">
        ...
        <main>
            <div class="head-title">
                <div class="left">
                    <h2 style ="font-family:Goudy Old Style; font-size: 26px;"><strong>Dashboard</strong></h2>
                    <ul class="breadcrumb">
                        <li>
                        ...
                        <li>
                            <a class="active" href="home_view.php" style ="font-family:Goudy Old Style; font-size: 17px;">Home</a>
                        </li>
                    </ul>
                </div>
            </div>
	...
	<a href="chore_management.php">
	    ...
	    <br>
	    <br>
            <h2 class="text-2xl font-bold mb-4" id="hungLeft"><strong> Recently Assigned Chores</strong></h2>
	    <h2 class="text-2xl font-bold mb-4" id="hungRight" style="color:blue"> View Assigned Chores</h2>
