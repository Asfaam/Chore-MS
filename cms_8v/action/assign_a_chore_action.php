...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $dateAssign = date('Y-m-d'); //  the assignment date is today's date
    $lastUpdated = date('Y-m-d'); //  the last updated date is today's date
    $dateCompleted = NULL; // the assignment is not completed initially
    $img = ''; //  no image is associated initially
