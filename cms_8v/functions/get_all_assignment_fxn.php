        ...
        foreach ($assignments as $assignment) {
           ...
           // Determine status color and status title based on status (update)
            ...
            switch ($assignment['sid']) {
                case 2: // InProgress
                    $statusColor = 'gold'; // Change color to gold
                    $statusTitle = 'InProgress'; // Set title to InProgress
                    break;
                case 3: // Completed
                    $statusColor = 'green'; // Change color to green
                    $statusTitle = 'Completed'; // Set title to Completed
                    break;
                case 4: // Incomplete
                    $statusColor = 'red'; // Change color to red
            ...
            echo "<td>";
            echo "<a href='../admin/update_assigned_chore_status.php?assignmentid=" . $assignment['assignmentid'] . "'>";
