...
<body class="bg-gray-100 p-4">
    ...
    <section id="content">
        <nav>
            ...
            <span class="text" style ="font-family:Goudy Old Style; font-size: 18px;"><small><strong><em>@admin...</em></strong></small></span>
        </a>
        </nav>
    ...
    <a href="chore_management.php">
        <div class="p-4 bg-white shadow-md rounded-md">
            <li class="assigned-chores"><span class="icon">&#x2611;</span><p class="text-lg font-bold"><em>All Assigned Chores</em></p></li>
	...
	<a href="chore_management.php">
        <div class="p-4 bg-white shadow-md rounded-md">
            <li class="incomplete"><span class="icon">&#x274C;</span><p class="text-lg font-bold"><em>Incomplete</em></p></li>
