...
if (isset($_GET['chore_id'])) {
    ...
    if ($chore) {
        ...
        <body>
            <h1>Edit Chore</h1>
            <form action="../action/edit_a_chore_action.php" method="POST" style="float:left">
	        ...
	        <a href="../admin/edit_chore_view.php">
                    <span style="float:right"><strong><button><i class='bx bx-chevron-left'> Back to AddChores</i></button></strong></span>
	        </a>
            </div>
        </body>
        </html>
